        ...
        <div class="row" dir="rtl">
            ...
            <div class="col-md-6 mb-5">
                <div class="pr-md-4">
                    ...
                    <p>إذا كانت الرسالة الصوتية متوفرة لديك فسيتم تفعيلها مباشرة لك.
أما إذا كنت ترغب بتسجيل رسالة صوتية تفاعلية مخصصة لك، فسيتم إرسال قائمة لك من الأصوات للاختيار منها للبدء بتفعيل الخدمة ( هذه الخدمة برسوم * ).</p>
                </div>
            </div>
        </div>
        <!-- End FAQ -->
