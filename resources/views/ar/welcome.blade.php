            ...
            <div class="row justify-content-lg-center">
                <div class="col-md-6 col-lg-5 mb-7 mb-md-0">
                    ...
                    <div class="text-center px-lg-4">
                        ...
                        <blockquote class="text-secondary mb-0">"هذه فرصة عظيمة لنشكر فيها اكسا كول عن تقديمهم لنظام لإدارة المكالمات ومركز التواصل الخاص بنا ذو كفاءة عالية والذي كان ملائم لاحتياجاتنا الخاصة بالإضافة إلى فريق خدمة العملاء المحترف والمخلص في عمله"</blockquote>
                    </div>
                    <!-- End Testimonials -->
                </div>
