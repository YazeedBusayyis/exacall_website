...
@section('meta')
    ...
    <!--  Essential META Tags -->
    <title>Contact us | ExaCall</title>
    ...
    <!--  OG -->
    <meta property="og:title" content="Contact us | ExaCall">
    ...
    <meta name="twitter:title" content="Contact us | ExaCall"/>
                            ...
                            <address>
                                ...
                                <ul class="list-unstyled text-secondary" style="padding-right: 0px;">
                                    ...
                                    <li class="media align-items-center py-2">
                                        ...
                                        <div class="media-body text-white" style = "display: contents;">Support : support@exacall.com</div>
                                    </li>
                                </ul>
                                <!-- End Contacts List -->
                            </address>
