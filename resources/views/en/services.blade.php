...
@section('meta')
    ...
    <!--  Essential META Tags -->
    <title>Solutions and Services | ExaCall</title>
    ...
    <!--  OG -->
    <meta property="og:title" content="Solutions and Services | ExaCall">
    <meta property="og:description" content="أفضل الحلول المبتكرة للاتصالات الهاتفية بنظام مرن ومتكامل لتخدم من خلاله الشركات ومراكز الاتصال">
    ...
    <meta name="twitter:title" content="Solutions and Services | ExaCall" />
    <meta name="twitter:description" content="أفضل الحلول المبتكرة للاتصالات الهاتفية بنظام مرن ومتكامل لتخدم من خلاله الشركات ومراكز الاتصال"/>
...
@section('content')
    ...
    <!-- Main Content -->
    <div class="container space-2 space-3--lg text-left" dir="ltr">
        <!-- Solutions -->
        <div class="row justify-content-lg-between">
            ...
            <div class="col-sm-6 mb-7 mb-sm-9">
                <!-- Icon Block -->
                <div class="pr-lg-4">
                    <img class="max-width-9 mb-2" src="/assets/svg/components/team-dark-icon.svg" alt="Image Description">
                    <p>
                        <b>CRM :</b>
                        <br>
                    <p class="text-justify">
                    Marketing, sales, warehouse or warehouse management, as well as technical support, all in one platform
To simplify the business for you and analyze your leads ’data to know your customers, their needs and your previous interactions with them
  To create the best customer experience for you
  </p>
                    </p>
                </div>
                <!-- End Icon Block -->
